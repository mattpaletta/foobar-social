...
extension Foobar_Posts_PostQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PostQuery"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Foobar_Posts_PostQuery, rhs: Foobar_Posts_PostQuery) -> Bool {
